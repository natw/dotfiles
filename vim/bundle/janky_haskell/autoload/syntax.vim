...
function! syntax#keywords(conceal_wide, conceal_enumerations, conceal_bad) " {{{
  syntax case match
...
function! syntax#strings(multiline_strings) " {{{
...
function! syntax#comments(conceal_comments, conceal_enumerations) " {{{
  syntax case match
